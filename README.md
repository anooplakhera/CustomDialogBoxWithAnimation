# CustomDialogBoxWithAnimation
Here today i make a custom Dialox Box with few part add of Animation , animation is that dialox open from down to up and close up to down , i'm sure it will be usefull for beginner and experienced now get the chance to get understanding what i do in Code...  thanks in Adn
